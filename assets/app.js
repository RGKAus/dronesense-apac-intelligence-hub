...
const SEARCH_INDEX = [
  // Agency Directory
  { type: 'Agency', title: 'Australian Federal Police (AFP)', href: 'agency-afp.html' },
  { type: 'Agency', title: 'NSW Police Force', href: 'agency-police-nsw.html' },
  { type: 'Agency', title: 'Victoria Police', href: 'agency-police-vic.html' },
  { type: 'Agency', title: 'Queensland Police Service (QPS)', href: 'agency-police-qld.html' },
  { type: 'Agency', title: 'Western Australia Police Force', href: 'agency-police-wa.html' },
  { type: 'Agency', title: 'South Australia Police (SAPOL)', href: 'agency-police-sa.html' },
  { type: 'Agency', title: 'Tasmania Police', href: 'agency-police-tas.html' },
  { type: 'Agency', title: 'ACT Policing', href: 'agency-police-act.html' },
  { type: 'Agency', title: 'Northern Territory Police Force', href: 'agency-police-nt.html' },
  ...
  { type: 'Agency', title: 'National Emergency Management Agency (NEMA)', href: 'agency-nema.html' },
  { type: 'Agency', title: 'Australian Border Force (ABF)', href: 'agency-abf.html' },
  { type: 'Agency', title: 'Australian Maritime Safety Authority (AMSA)', href: 'agency-amsa.html' },
  { type: 'Agency', title: 'Australian Transport Safety Bureau (ATSB)', href: 'agency-atsb.html' },
  { type: 'Agency', title: 'Department of Home Affairs', href: 'agency-homeaffairs.html' },
  { type: 'Agency', title: 'Defence (domestic support)', href: 'agencies-hub.html?type=Defence' },
  { type: 'Agency', title: 'CASA — Civil Aviation Safety Authority', href: 'regulation-casa.html' },
  { type: 'Agency', title: 'Airservices Australia', href: 'agency-airservices.html' },
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (notebookList) {
    ...
    const PAGE_LABELS = {
      ...
      'regulation-casa': 'CASA',
      'regulation-part-101': 'CASR Part 101',
      'regulation-repl': 'Remote Pilot Licence (RePL)',
      'regulation-reoc': "RPA Operator's Certificate (ReOC)",
      'regulation-aussora': 'BVLOS & AusSORA',
      'agency-afp': 'Australian Federal Police (AFP)',
      'agency-abf': 'Australian Border Force (ABF)',
      'agency-amsa': 'Australian Maritime Safety Authority (AMSA)',
      'agency-nema': 'National Emergency Management Agency (NEMA)',
      'agency-airservices': 'Airservices Australia',
      'agency-atsb': 'Australian Transport Safety Bureau (ATSB)',
      'agency-homeaffairs': 'Department of Home Affairs',
      'agency-police-nsw': 'NSW Police Force',
      'agency-police-vic': 'Victoria Police',
      'agency-police-qld': 'Queensland Police Service (QPS)',
      'agency-police-wa': 'Western Australia Police Force',
      'agency-police-sa': 'South Australia Police (SAPOL)',
      'agency-police-tas': 'Tasmania Police',
      'agency-police-act': 'ACT Policing',
      'agency-police-nt': 'Northern Territory Police Force',
    };
